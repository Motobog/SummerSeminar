...
Иногда в репозитории могут находится файлы, изменение которых бессмысленно отслеживать. Например изображения. Для того чтобы Git знал об этом и не выдавл предупреждений необходимо сделать следующее:
