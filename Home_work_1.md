...
\- позволяет вернуться к актуальной версии файла после просмотра ранее комитов.

***

#### ***git diff***

\- сравнивает записаную версию файла с последним коммитом. Если изменения внесены, но файл не записан - команда ничего не покажет.